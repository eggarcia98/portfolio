                ...
                <div className="grid gap-4 lg:grid-cols-12 my-6">
                    ...
                    <ScrollReveal delay={80} className="lg:col-span-7">
                        <Link
                            ...
                            className="surface group relative block w-full overflow-hidden p-8 transition-all hover:shadow-sm"
                        >
                    ...
                    <div className="grid gap-4 lg:col-span-5">
                        <ScrollReveal delay={160}>
                            <Link
                                ...
                                className="surface group relative block w-full overflow-hidden p-6 transition-all hover:shadow-sm"
                            >
