                ...
                <div className="grid gap-12 lg:gap-16 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        <Link href="/" className="inline-flex items-center gap-3 mb-6">
                            <div className="h-10 w-10 rounded-full bg-teal-600 dark:bg-teal-500 flex items-center justify-center">
                        ...
                        <p className="text-sm font-light text-slate-600 dark:text-slate-400 leading-relaxed max-w-sm">
