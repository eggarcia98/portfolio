        ...
        <div className="min-h-dvh bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
            ...
            <main className="container-page py-16 lg:py-24">
                <PageHeader
                    ...
                    title="Let's connect"
                    description="Open to backend engineering, cloud/DevOps, and technical support roles. Available for remote opportunities worldwide."
                />

                <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:max-w-4xl">
                    <ContactCard
                        label="Email"
                        value="eggarcia9814@gmail.com"
                    ...
                    <ContactCard
                        label="LinkedIn"
                        value="linkedin.com/in/eggarcia98"
