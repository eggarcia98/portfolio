            ...
            <main className="container-page py-16 lg:py-24">
                <div className="max-w-4xl">
                    ...
                    <p className="lead mt-6 max-w-2xl">
                        Open to backend engineering, cloud/DevOps, and technical support roles. Available for remote opportunities worldwide.
                    </p>
                </div>

                <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:max-w-4xl">
                    <a
                        className="surface p-7 transition-all hover:shadow-lg"
