                        ...
                        <div className="grid items-start gap-8 lg:grid-cols-12 lg:gap-12">
                            ...
                            <div className="lg:col-span-7">
                                ...
                                <p className="mt-8 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                                    Specializing in production systems, database optimization, and cloud infrastructure. 
                                    I build backend solutions that scale with precision and reliability.
                                </p>

                                {/* CTA Buttons */}
                                <div className="mt-10 flex flex-wrap items-center gap-4">
                                    <Link href="/projects" className="btn btn-primary text-base">
                                ...
                                <div className="mt-16 grid grid-cols-3 gap-8 border-t border-slate-200 pt-8 dark:border-slate-800">
                                    <div>
                                        ...
                                        <div className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">Years Experience</div>
                                    </div>
                                    <div>
                                        <div className="text-3xl font-bold text-slate-900 dark:text-white">4</div>
                                        <div className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">Major Projects</div>
                                    </div>
                                    <div>
                                        <div className="text-3xl font-bold text-slate-900 dark:text-white">99%</div>
                                        <div className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400">Uptime Focus</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="surface p-8 lg:sticky lg:top-24">
                                    <div className="mb-8">
                                        ...
                                        <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                            Production-tested stack for building scalable systems
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {['TypeScript', 'Node.js', 'Python', 'Fastify', 'Express'].map((tech) => (
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {['Docker', 'Google Cloud', 'CI/CD', 'Linux'].map((tech) => (
                                                    <span key={tech} className="chip">
                                                        {tech}
                                                    </span>
                                                ))}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {['Git', 'Bash', 'REST APIs', 'Networking'].map((tech) => (
                                                    <span key={tech} className="chip">
                                                        {tech}
                                                    </span>
                                                ))}
